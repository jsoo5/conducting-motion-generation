...
# import data_processing.process_dataset as proc_data
...
if __name__ == '__main__':
    ...
    encoding = tr.encode(nn, input)
    print('encoding.shape: ', encoding.shape)

    name = path.basename(args.input_file)
    output_path = path.join(args.output_file, f'encoded_{name}')
