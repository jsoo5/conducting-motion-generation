...
flags.DEFINE_integer('frame_size', 45, 'Dimensionality of the input for a single frame')
...
flags.DEFINE_integer('layer2_width', 48, 'Number of units in each hidden layer ')
